...
object CommonDescription {
    const val createdAt = "The date when the legal entity data record has been created."
    const val updatedAt = "The date when the legal entity data record has been last updated."
