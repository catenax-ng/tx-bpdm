...
data class LogisticAddressGateDto(
    ...
    @get:ArraySchema(arraySchema = Schema(description = "Indicates if the LogisticAddress is \"Active\" or \"Inactive\"."))
    val states: Collection<AddressStateDto> = emptyList(),

    @get:ArraySchema(arraySchema = Schema(description = "List of identifiers"))
