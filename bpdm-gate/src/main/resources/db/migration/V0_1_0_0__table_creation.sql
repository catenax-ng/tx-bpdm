...
CREATE INDEX idxqsn69x58x1ks64jhmcs1l796k ON localities USING btree (address_id);
...
CREATE INDEX idxjf0olkcrrt1dd3d5lc5mc34ft ON post_codes USING btree (address_id);
...
CREATE INDEX idxho27o3xxdc5b3yeur262pprq1 ON postal_delivery_points USING btree (address_id);
...
CREATE INDEX idxf1ppnm80ih8b4gqo91scd3k5k ON premises USING btree (address_id);
...
CREATE INDEX idxr37crovik7xrvr8mfk9wfimmh ON thoroughfares USING btree (address_id);
